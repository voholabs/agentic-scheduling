    ...
    <>
      <div className="group text-[12px] relative">
        {asOpenSelect ? (
          ...
          <div
            className={clsx(
              'flex items-center gap-[8px] h-[32px] px-[12px] rounded-[8px] border border-btnPrimary text-btnPrimary font-[600] transition-colors select-none',
              multiple && 'cursor-pointer hover:bg-btnPrimary hover:text-white'
            )}
          >
            <svg
              className={
        ...
        {multiple && (
          <div
            className={clsx(
              'hidden group-hover:flex absolute top-[100%] end-0 z-[200] min-w-[220px] flex-col overflow-hidden rounded-[8px] border border-btnPrimary bg-newBgColorInner shadow-lg',
              asOpenSelect
            ...
            {data.map((org: { name: string; id: string }) => {
              ...
              return (
                <div
                  ...
                  className={clsx(
                    'flex items-center justify-between gap-[12px] py-[10px] px-[12px] transition-colors',
                    isCurrent
